...
const LandingPage = () => {
  return (
    <div className="w-full h-[100vh] bg-hero_primary overflow-hidden relative">
      <img
        src={"/images/dog.webp"}
        className="absolute bottom-0 right-0 z-10 h-3/4"
        alt="Dog"
      />
      ...
      <div className="flex h-full w-full items-center justify-center ">
        <div className="flex flex-col w-3/4 h-full justify-center items-end">
          <h1 className="max-w-md text-sm md:text-lg lg:text-2xl xl:text-3xl font-semibold font-sans text-balance leading-tight z-50 m-6 transform translate-x-20 duration-500 ease-out">
